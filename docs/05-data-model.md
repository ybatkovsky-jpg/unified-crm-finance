...
> ⚠️ **Архивный документ.** Описывает исходную модель на ~42 сущности. Фактически схема выросла до **68 моделей** (актуальная — `apps/web/prisma/schema.prisma`). Канон моделей — код, а не этот файл. Сохранено для истории.
