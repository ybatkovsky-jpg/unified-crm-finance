...
Документ находится в статусе **Draft (v0.1.0)** и ожидает ревью заказчика. После согласования каждой части номер версии увеличивается по semver: правки мелких неточностей — patch, новые требования или разделы — minor, изменение архитектурных решений — major.
