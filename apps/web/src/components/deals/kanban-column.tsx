...
export function KanbanColumn({
  ...
  return (
    <div
      ref={setNodeRef}
      className={cn(
        "flex flex-col w-72 min-w-72 h-full rounded-xl border bg-card/50 backdrop-blur-sm transition-[background-color,border-color,box-shadow,transform] duration-200",
