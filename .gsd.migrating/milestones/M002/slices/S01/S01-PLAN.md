...
- [ ] **T01: Prisma migrations for CRM models** `est:15m`
...
- [ ] **T02: Create lib/db/prisma.ts and lib/db/contacts.ts** `est:30m`
...
- [ ] **T03: Create Contact API routes (Next.js)** `est:45m`
...
- [ ] **T04: Create lib/api/contacts.ts client helpers** `est:20m`
